...
const videoTitle = ref('Sunday Morning - Vintage "La La Land" Style Maroon 5 Cover ft. Addie Hamilton');
      ...
      <div class="lg:w-4/12 lg:px-3">
        <v-card class="h-full relative" title="ChitChat" rounded="xl">
          <v-card-text class="flex flex-col gap-2">
            <v-card flat :color="colors.grey.lighten4" rounded="lg" subtitle="e"></v-card>
            <v-card flat :color="colors.grey.lighten4" rounded="lg" subtitle="e"></v-card>
          ...
          <div class=" lg:absolute bottom-0 w-full">
            <v-card-text>
              <div class="w-full flex gap-2 ">
                <span class="w-full">
                <v-text-field color="primary" rounded="lg" density="compact" label="Message" variant="outlined"></v-text-field>
              </span>
                <span>
                  <v-btn  color="primary" flat rounded="lg" append-icon="mdi-send-outline" ></v-btn>
                </span>
              </div>
            </v-card-text>
          </div>
